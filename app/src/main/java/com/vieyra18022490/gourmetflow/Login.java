...
public class Login extends AppCompatActivity {
    ...
    public void movepage(View v) { //method
       //Ensure the Input is not null
        ...
        {
            Toast.makeText(Login.this, "Enter a username!",
                    Toast.LENGTH_SHORT).show();
        }
        else if(!uname.getText().toString().isEmpty() && upass.getText().toString().isEmpty())
        {
            Toast.makeText(Login.this, "Enter a Password!",
                    Toast.LENGTH_SHORT).show();
        }
        else if(uname.getText().toString().isEmpty() && upass.getText().toString().isEmpty())
        {
            Toast.makeText(Login.this, "Enter a Username and Password!",
                    Toast.LENGTH_SHORT).show();
        }
        else if(!uname.getText().toString().isEmpty()&& !upass.getText().toString().isEmpty())
        {
